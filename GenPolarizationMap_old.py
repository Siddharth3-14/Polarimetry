...
# #takinng data from imported fits files
# plank_I_data = plank_I_fits.data[:,:1365]
# plank_Q_data = plank_Q_fits.data[:,:1365]
# plank_U_data = plank_U_fits.data[:,:1365]
...
plank_theta_mod = (180/np.pi)*0.5*np.arctan((-1)*plank_U_data/plank_Q_data) + 90 
...
DEC_grid_avg,_ = bining_avg(DEC_grid,8)
RA_grid_avg,_ = bining_avg(RA_grid,8)
polarization_avg , polarization_error = bining_avg(plank_polarization,8)
theta_avg,theta_error = bining_avg(plank_theta_mod,8)
